...
class UnidadeMedidaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setData( TSession::getValue('UnidadeMedida_filter_data') );
        ...
        $column_nome = new TDataGridColumn('nome', 'Nome', 'left', '95%');
    ...
    public function onInlineEdit($param)
    {
        try
        {
            ...
            $object = new UnidadeMedida($key); // instantiates the Active Record
            $object->{$field} = $value;
    ...
    public function onSearch()
    {
        ...
        TSession::setValue('UnidadeMedidaList2_filter_nome',   NULL);

        if (isset($data->nome) AND ($data->nome)) {
            $filter = new TFilter('nome', 'like', "%{$data->nome}%"); // create the filter
            TSession::setValue('UnidadeMedidaList2_filter_nome',   $filter); // stores the filter in the session
        }
        ...
        TSession::setValue('UnidadeMedida_filter_data', $data);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for UnidadeMedida
            ...
            if (TSession::getValue('UnidadeMedidaList2_filter_nome')) {
                $criteria->add(TSession::getValue('UnidadeMedidaList2_filter_nome')); // add the session filter
            }
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('procon_com'); // open a transaction with database
            $object = new UnidadeMedida($key, FALSE); // instantiates the Active Record
